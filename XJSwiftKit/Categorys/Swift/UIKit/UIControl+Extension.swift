...
public extension XJExtension where Base: UIControl {
...
fileprivate extension UIControl  {
    ...
    private var hitTime: Double? {
        get { return xj_getAssociatedObject(self, &hitTimerKey) }
        set { xj_setRetainedAssociatedObject(self, &hitTimerKey, newValue, .OBJC_ASSOCIATION_ASSIGN) }
    }
    ...
    @objc func c_preventDoubleHit(_ base: UIControl)  {
        ...
        DispatchQueue.xj.asyncDelay(hitTime ?? 1.0) {
        } _: {
