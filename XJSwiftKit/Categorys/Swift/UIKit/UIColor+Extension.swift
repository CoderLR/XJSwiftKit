...
public extension UIColor {
    ...
    func colorToRGBA() -> (r: CGFloat?, g: CGFloat?, b: CGFloat?, a: CGFloat?) {
        ...
        return ("\(Int(red * multiplier))".xj.toCGFloat(), "\(Int(green * multiplier))".xj.toCGFloat(), "\(Int(blue * multiplier))".xj.toCGFloat(), alpha)
    }
    
    // MARK: 3.4、color 转 RGB
    /// color 转 RGB
    /// - Returns: 返回对应的 RGB
    func colorToRGB() -> (r: CGFloat, g: CGFloat, b: CGFloat) {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
        ...
        return ("\(Int(red * multiplier))".xj.toCGFloat() ?? 0,
                "\(Int(green * multiplier))".xj.toCGFloat() ?? 0,
                "\(Int(blue * multiplier))".xj.toCGFloat() ?? 0)
    }
}
