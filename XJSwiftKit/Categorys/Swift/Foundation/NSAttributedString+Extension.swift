...
extension NSAttributedString: XJCompatible {}

// MARK:- 一、文本设置的基本扩展
public extension XJExtension where Base: NSAttributedString {
    ...
    func setSpecificRangeDeleteLine(color: UIColor, range: NSRange) -> NSAttributedString {
        ...
        let version = UIDevice.xj.currentSystemVersion as NSString
