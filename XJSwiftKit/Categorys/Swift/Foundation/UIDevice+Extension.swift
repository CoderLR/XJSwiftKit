...
extension UIDevice: XJCompatible {}
// 这里只指屏幕类型
...
// MARK:- 一、基本的扩展
public extension XJExtension where Base: UIDevice {
    ...
    static func screenType() -> UIDeviceScreenType {
        let modelName = Base.xj.modelName
    ...
    static func isIphone5Screen() -> Bool {
        if Base.xj.screenType() == .IPHONE_5 {
            return true
        }
        return false
    }
    ...
    static func isIphone6Screen() -> Bool {
        if Base.xj.screenType() == .IPHONE_6 {
            return true
        }
        return false
    }
    ...
    static func isIphoneXScreen() -> Bool {
        if Base.xj.screenType() == .IPHONE_X || Base.xj.screenType() == .IPHONE_XS || Base.xj.screenType() == .IPHONE_XR || Base.xj.screenType() == .IPHONE_XS_Max ||  Base.xj.screenType() == .IPHONE_11 ||  Base.xj.screenType() == .IPHONE_11_PRO ||  Base.xj.screenType() == .IPHONE_11_PRO_MAX {
            return true
        }
        return false
    }
    ...
    static func isIphoneXSScreen() -> Bool {
        if Base.xj.screenType() == .IPHONE_XS || Base.xj.screenType() == .IPHONE_XR || Base.xj.screenType() == .IPHONE_XS_Max {
            return true
        }
        return false
    }
...
public extension XJExtension where Base: UIDevice {
    ...
    static var isJailbroken: Bool {
        ...
        let path = String(format: "/private/%@", String.xj.stringWithUUID() ?? "")
        do {
