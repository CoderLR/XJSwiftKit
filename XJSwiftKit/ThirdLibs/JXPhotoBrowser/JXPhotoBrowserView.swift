...
//let circleTopH: CGFloat = KStatusBarH + 44
//let circleBottomH: CGFloat = KHomeBarH + 44

open class JXPhotoBrowserView: UIView, UIScrollViewDelegate {
    
//    // 点击次数
//    open var clickIndex: Int = 0
//    open var textHeight: CGFloat = 0
    
//    /// 是否是历史消息
//    var isCirclePhotoBrowser: Bool = false {
//        didSet {
//            self.addCircleTopAndBottomView()
//        }
//    }
    
//    /// 课程圈消息
//    var circleInfo: NDModel_CourseCircle? {
//        didSet {
//            self.topView.circleInfo = circleInfo
//            self.bottomView.circleInfo = circleInfo
//
//            if circleInfo?.description ?? "" != "" {
//                self.addCircleTextView()
//            }
//        }
//    }
    
    /// 课程圈浏览返回
    var circlePhotoBrowserBackBlock: (() -> ())?
    
    /// 课程圈评论点击
    var circlePhotoBrowserCommentBlock: ((_ index: Int) -> ())?
...
//    var topView: JXCircleTopView = {
//        let view = JXCircleTopView(frame: CGRect.zero)
//        return view
//    }()
//
//    var bottomView: JXCircleBottomView = {
//        let view = JXCircleBottomView(frame: CGRect.zero)
//        return view
//    }()
//
//    var textView: JXCircleTextView = {
//        let view = JXCircleTextView(frame: CGRect.zero)
//        return view
//    }()
...
//    open func addCircleTextView() {
//
//        if self.isCirclePhotoBrowser {
//
//            textView.circleInfo = self.circleInfo
//            addSubview(textView)
//
//            self.setNeedsLayout()
//        }
//    }
//
//    open func addCircleTopAndBottomView() {
//        weak var weakSelf = self
//        if self.isCirclePhotoBrowser{
//            print("-----------创建顶部view")
//            addSubview(topView)
//            addSubview(bottomView)
//            topView.circleTopViewClick = {
//                () -> () in
//                weakSelf?.photoBrowser?.dismiss()
//            }
//            bottomView.circleBottomViewClick = {
//                (index) -> () in
//
//                //weakSelf?.photoBrowser?.dismiss()
//                weakSelf?.stopAllVideo()
//                if let block = weakSelf?.circlePhotoBrowserCommentBlock {
//                    block(index)
//                }
//            }
//
...
//    }
//
//    open func stopAllVideo() {
//        for (_, cell) in self.visibleCells {
//            if cell.isKind(of: JXCircleVideoCell.self) {
//                (cell as! JXCircleVideoCell).stop()
//                (cell as! JXCircleVideoCell).playEnd()
//            }
//        }
//    }
//
//    // 显示隐藏顶部
//    open func changeTopAndBottomFrame(isHidden: Bool) {
//        // 显示
//        if !isHidden {
//            if self.topView.y == 0 { return }
//            UIView.animate(withDuration: 0.25) {
//                self.topView.y += circleTopH
//                self.bottomView.y -= circleBottomH
//                if self.circleInfo?.description ?? "" != "" {
//                    self.textView.y -= circleBottomH
//                }
//            }
//        // 收起
//        } else {
//            if self.topView.y == -circleTopH { return }
//            UIView.animate(withDuration: 0.25) {
//                self.topView.y -= circleTopH
//                self.bottomView.y += circleBottomH
//                if self.circleInfo?.description ?? "" != "" {
...
//        if self.isCirclePhotoBrowser {
//            topView.frame = CGRect(x: 0, y: 0, width: self.width, height: circleTopH)
//            bottomView.frame = CGRect(x: 0, y: self.height - circleBottomH, width: self.width, height: circleBottomH)
//
//            if circleInfo?.description ?? "" != "" {
//                textHeight = circleInfo?.description?.ga_heightForComment(fontSize: 14, width: self.width - 2 * 16) ?? 0
//                textView.frame = CGRect(x: 0, y: bottomView.y - (textHeight + 16), width: self.width, height: textHeight + 16)
//            }
//        }
