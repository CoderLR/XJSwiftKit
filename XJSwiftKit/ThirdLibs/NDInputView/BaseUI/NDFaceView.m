...
@interface NDFaceView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_faceCollectionView registerClass:[NDFaceCell class] forCellWithReuseIdentifier:TFaceCell_ReuseId];
...
{
    NDFaceCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TFaceCell_ReuseId forIndexPath:indexPath];
