 ...
 *  目前 ND 实现并提供了上述的4种功能。如果上述的4中功能还无法满足您的功能需求的话，您也可以在本视图内添加您的自定义单元。
 *
 *  NDMoreView 在已有的文本消息收发基础上提供了视频、图片、文件等多媒体消息的发送入口。
...
/**
 *  设置数据
 *  用来进行 NDMoreView 的数据初始化或在有需要时设置新的数据。
 *  数组中存放的元素类型为 NDInputMoreCellData。
 *
 *  @param data     需要设置的数据
 */
