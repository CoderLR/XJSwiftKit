...
@interface NDMoreView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_moreCollectionView registerClass:[NDInputMoreCell class] forCellWithReuseIdentifier:TMoreCell_ReuseId];
...
- (void)defaultLayout
{
    CGSize cellSize = [NDInputMoreCell getSize];
...
{
    NDInputMoreCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMoreCell_ReuseId forIndexPath:indexPath];
    NDInputMoreCellData *data;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(moreView:didSelectMoreCell:)]){
        if ([cell isKindOfClass:[NDInputMoreCell class]]) {
            [_delegate moreView:self didSelectMoreCell:(NDInputMoreCell *)cell];;
        }
    }
}
...
{
    return [NDInputMoreCell getSize];
}
