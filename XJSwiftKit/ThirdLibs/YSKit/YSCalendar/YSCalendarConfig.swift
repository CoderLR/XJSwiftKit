...
//let nowYear: Int = YSDateTool.currentYear()
//let nowMonth: Int = YSDateTool.currentMonth()
//let nowDay: Int = YSDateTool.currentDay()
//
//var currentYear: Int = nowYear
//var currentMonth: Int = nowMonth
//var currentDay: Int = nowDay
//
//func isNowDate(_ dayModel: YSDayModel) -> Bool {
//    return (dayModel.year == nowYear &&
//            dayModel.month == nowMonth &&
//            dayModel.day == nowDay)
//}
//
//func isCurrentDate(_ dayModel: YSDayModel) -> Bool {
//    return (dayModel.year == currentYear &&
//            dayModel.month == currentMonth &&
//            dayModel.day == currentDay)
//}
...
//}
//
//func setCurrentDate(_ dayModel: YSDayModel) {
//    currentYear = dayModel.year
//    currentMonth = dayModel.month
//    currentDay = dayModel.day
//    print("current = \(currentYear) - \(currentMonth) - \(currentDay)")
//}
//
//func setCurrentDate(year: Int, month: Int, day: Int) {
//    currentYear = year
//    currentMonth = month
//    currentDay = day
//    print("current = \(currentYear) - \(currentMonth) - \(currentDay)")
