...
@protocol YSSimplePingDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, YSSimplePingAddressStyle) {
    YSSimplePingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    YSSimplePingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    YSSimplePingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@interface YSSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<YSSimplePingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) YSSimplePingAddressStyle addressStyle;
...
@protocol YSSimplePingDelegate <NSObject>
