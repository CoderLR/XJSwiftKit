...
public struct YSQRCodeTool {
    ...
    public static func qrCodeImage(content: String,
        ...
        if let newLogoRoundCorner = logoRoundCorner, let roundCornerLogo = logo.xj.isRoundCorner(radius: newLogoRoundCorner, byRoundingCorners: .allCorners, imageSize: logoSize) {
