...
public struct YSAppTool {
    ...
    public static func compareVersion(version: String) -> Bool {
        ...
        // 2、当前版本的版本号获取 三位Int值
        let currentVersion = Bundle.xj.appVersion
...
private extension YSAppTool {
    ...
    static func appVersion(version: String) -> (isSuccess: Bool, versions: [Int]) {
        ...
        guard let versionValue1 = versionString1.xj.toInt(), let versionValue2 = versionString2.xj.toInt(), let versionValue3 = versionString3.xj.toInt() else {
            return (false, [])
        }
